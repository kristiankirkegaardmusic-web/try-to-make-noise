...
const CFG = {
  /* Palet */
  bg:   [245, 245, 245],         // næsten sort, en anelse grøn
...
function drawHint() {
  ...
  noStroke();
  rectMode(CENTER);
  fill(CFG.bg[0], CFG.bg[1], CFG.bg[2], hintAlpha * 0.98);
  rect(width / 2, height - 518, 2250, 5222);
  ...
  text('CLICK TO ENABLE MICROPHONE', width / 2, height - 510);
  pop();
}
